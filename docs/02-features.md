...
- **Manhattan Routing**: Professional-grade SVG graph paths with S-curves and anchor points.
- **Gravatar Avatars**: High-performance author visualization with fallback initials.
- **Branch Filtering**: Real-time filtering for Local, Remote, Active, or All branches.
