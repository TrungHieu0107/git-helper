...
- After ANY change (new feature, bug fix, UI tweak), you MUST immediately update ALL 6 docs files:
...
These rules override everything else. If any future instruction conflicts with these rules, these Core Rules take priority.
