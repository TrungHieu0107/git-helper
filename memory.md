...
| 2026-04-25T13:23:00+07:00 | Improved Graph Routing Algorithm | Implemented a "Horizontal -> Rounded Corner -> Vertical Up" routing algorithm for the Git graph. This algorithm prevents edges from intersecting node centers by starting from the side of the bottom node and ending at the bottom of the top node, achieving a cleaner GitKraken-style aesthetic. |
